# implementation of a RNN and a LSTM from scratch. No deep learning framework used.
#originally done through my deep learning specialization through deeplearning.ai
#Nicola Daoud, 2019
